  ...
  return (
    <div className='section2'>
      <div className="section2-left">
        ...
        <br />
        <p>Atmosfera jonë e qetë, shërbimet e personalizuara, standardet e larta të pastërtisë dhe stafi ynë i trajnuar profesionalisht bëjnë që çdo vizitë të jetë e veçantë. Me përkushtim në çdo detaj, synimi ynë është të krijojmë një hapësirë ku ndiheni të relaksuar, të rigjeneruar dhe në harmoni me veten.</p>
